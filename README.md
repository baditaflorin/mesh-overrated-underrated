...
**Source → https://github.com/baditaflorin/mesh-overrated-underrated**
...
git clone https://github.com/baditaflorin/mesh-overrated-underrated
cd mesh-overrated-underrated
npm install
npm run dev
```
...
- `mesh-overrated-underrated:signalingUrl`
- `mesh-overrated-underrated:turnTokenUrl`
- `mesh-overrated-underrated:iceServers`
- `mesh-overrated-underrated:room`
